...
Public Class PublicFunction
    Public Shared Function ExportToExcel(ByVal a_sFilename As String, ByVal a_sData As DataTable, ByVal a_sFileTitle As String, ByRef a_sErrorMessage As String) As Boolean
        ...
        Try
            ...
            Try
                ...
                xlWB.SaveAs(a_sFilename, 56, Nothing, Nothing, Nothing, Nothing,
        ...
        Return bRetVal
    End Function
    Public Shared Function FormatDateToStandard(ByVal inputDate As String)
        Try
            Dim myDate As Date = CDate(inputDate)
    ...
    End Function
    Public Shared Function RoundToNearest05(value As Double) As Double
        Return Math.Round(value / 0.05, MidpointRounding.AwayFromZero) * 0.05
    End Function
    Public Shared Function SearchByTell(ByVal inputDate As String)
        Try
            Return BaseDataObject.DataAccess.GetRow("reonet_customer", "tell1 = '0" + inputDate + "' OR tell1 ='" + inputDate + "' OR tell1='" + inputDate.Substring(1) + "'")
        Catch ex As Exception
            Return Nothing
        End Try
    End Function
    ...
    Public Shared Function InsertKalaPrice(ByVal Srl_Stg_Kala As Integer, ByVal Srl_FactorMaster As Integer _
        ...
        If DefaultPrice = -1 Then
            Dim dr_gheimat As DataRow = BaseDataObject.DataAccess.GetRow("SELECT     Srl, ISNULL(FroshPrice, 0) AS froshprice " &
    ...
    Public Shared Function GetSettingTable(Optional ByVal Srl_User As String = Nothing _
        ...
        sqlcm.CommandText = "SELECT     dbo.Sec_Setting.srl, dbo.Sec_Setting.Srl_Sec_From, dbo.Sec_Setting.Srl_Sec_Groups, dbo.Sec_Setting.Srl_Sec_Users, dbo.Sec_Setting.ObjectName, " &
  "      dbo.Sec_Setting.ObjectType, dbo.Sec_Setting.PropName, dbo.Sec_Setting.PropValue,dbo.Sec_Setting.Dis, dbo.Sec_Setting.Visible, dbo.Sec_Setting.Active " &
" FROM         dbo.Sec_Setting INNER JOIN " &
