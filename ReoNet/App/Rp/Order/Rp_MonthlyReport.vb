...
Public Class Rp_MonthlyReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReoNet.Rp_MonthlyReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRp_MonthlyReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rp_MonthlyReport = New Rp_MonthlyReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
