...
namespace CS_Component
{
    public class DataGridView : System.Windows.Forms.DataGridView
    {
        ...
        protected override void OnRowPostPaint(DataGridViewRowPostPaintEventArgs e)
        {
            ...
            {
                Alignment = StringAlignment.Center,        // وسط افقی
                LineAlignment = StringAlignment.Center     // وسط عمودی
            })
            {
                // کمی جابه‌جایی برای قشنگی
                headerBounds.Y += 2;
        ...
        public DataGridView()
        {
            ...
            ToolStripMenuItem item = new ToolStripMenuItem("Search", null, new EventHandler(this.OnMnuSearchClick));
            //ToolStripMenuItem item2 = new ToolStripMenuIte
            //ToolStripMenuItem item2 = new ToolStripMenuItem("Export To File", null, new EventHandler(Export_Click));
            //ToolStripMenuItem item3 = new ToolStripMenuItem("Import From File", null, new EventHandler(Import_Click));
            ToolStripMenuItem item4 = new ToolStripMenuItem("Print", null, new EventHandler(Print_Click));
            ToolStripMenuItem item5 = new ToolStripMenuItem("Export To Excel", null, new EventHandler(Export_Excel_Click));
