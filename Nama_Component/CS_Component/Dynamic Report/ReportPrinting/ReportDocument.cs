...
namespace Cs_Component
{
    ...
    /// An object implementing <see cref="IReportMaker"/>
    ...
    /// <see cref="TextStyle"/> class.  It will generally
    /// use the <see cref="ReportBuilder"/> class to
...
//            this.reset();
            ...
            this.currentPage++; // pre increment, so the first page is page 1
            PrintAPage(e, false);
