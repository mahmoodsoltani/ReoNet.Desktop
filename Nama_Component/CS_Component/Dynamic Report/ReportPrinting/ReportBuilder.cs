...
namespace Cs_Component
{
	...
	/// <see cref="ReportDocument"/> to be built.
	/// </para>
    /// <para>
...
//        }
        ...
        void DgAddColumns (SectionTable table, System.Windows.Forms.DataGridTableStyle tableStyle)
        {
                         ...
                         in tableStyle.GridColumnStyles)
            {
                ...
                ReportDataColumn col = AddColumn(columnStyle.MappingName,
                    ...
                    true,
                    true,
                    (Cs_Component.HorizontalAlignment)columnStyle.Alignment);
        ...
        /// <param name="textStyle">The <see cref="TextStyle"/> for the text.</param>
        /// <param name="hAlign">The <see cref="HorizontalAlignment"/>
        /// for the text.</param>
