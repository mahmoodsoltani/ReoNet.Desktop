...
Public Class BaseForm
    ...
    Private Sub GetData(ByVal Control As Control)
        For Each C As Control In Control.Controls
            If (C.Controls.Count <> 0 And Not (TypeOf (C) Is CS_Component.TextBox Or TypeOf (C) Is VB_Component.PictureGetter Or TypeOf (C) Is VB_Component.TimeSelect Or TypeOf (C) Is CS_Component.LookupBox Or TypeOf (C) Is VB_Component.LookUpButton)) Then
                GetData(C)
            Else
