...
#Region "Properties"
    ...
    <Description("Get or Set if the gLabel will Glow when the mouse is over it")> _
    ...
    ''' </summary>
    <Category("Appearance")> _
    <Description("Get or Set what color the gLabel will Glow when the mouse is over it")> _
    ...
    ''' </summary>
    <Category("Appearance")> _
    <Description("Get or Set what Forecolor the gLabel will be when the mouse is over it")> _
    <DefaultValue(GetType(Color), "MediumBlue")> _
                ...
                If _Checked = False Then
                    ...
                    If value Then
                        ...
                        For Each ctrl As Control In Parent.Controls
                            If ctrl.GetType Is GetType(gLabel) Then
                                Dim tgLabel As gLabel = CType(ctrl, gLabel)
                                If tgLabel.CheckedType = eCheckedType.Radio AndAlso tgLabel.Checked Then
    ...
    ''' </summary>
    <Category("Appearance")> _
    <Description("Get or Set if the gLabel should be Pulsing or not")> _
    <RefreshProperties(RefreshProperties.Repaint)> _
    <DefaultValue(False)> _
    ...
    ''' </summary>
    <Category("Appearance")> _
    <Description("Get or Set how fast to pulse the gLabel")> _
     <DefaultValue(25)> _
   Public Property PulseSpeed() As Integer
    ...
    ''' </summary>
    <Category("Appearance")> _
    <Description("Get or Set if the gLabel displays the shadow text")> _
    <DefaultValue(False)> _
    ...
    ''' </summary>
    <Description("The Fill Type to apply to the gLabel")> _
    <Category("Appearance")> _
    ...
    ''' </summary>
    <Description("The ColorBlend used to fill the gLabel"), _
    Category("Appearance"), _
    ...
    Private Sub MakeTextPath(ByRef path As GraphicsPath, ByRef g As Graphics)
        ...
        If _AutoFit Then
            Try
                ...
                'Add Padding
                Dim TextMargin As Padding = System.Windows.Forms.Padding.Add(Padding, New Padding(pad))
        ...
        If (Not context Is Nothing) And (Not provider Is Nothing) Then
            ...
            If Not editorService Is Nothing Then
                ...
                Using dropDownEditor As DropdownColorBlender = New DropdownColorBlender(editorService)
                    ...
                    Dim Instance As New gLabel()
                    If context.Instance.GetType Is GetType(gLabel) Then
                        'For PropertyGrid
                        Instance = CType(context.Instance, gLabel)
                        'Else
                        'For SmartTag To be added later
                        'Instance = CType(CType(context.Instance, glabelActionList).CurrControl, gLabel)
                    End If
                    ...
                    With dropDownEditor
                        ...
                        .TheSample.FillType = gLabel.eFillType.GradientLinear
